...
public class modificargrafo extends javax.swing.JFrame {
     ...
     */
    public modificargrafo(Grafo nuevo) {
        initComponents();
        this.grafo = nuevo;
    ...
    private void initComponents() {
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 510, -1, -1));
...
eliminarproteina m = new eliminarproteina (grafo);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton2ActionPerformed

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
Insertarproteina m = new Insertarproteina (grafo);
this.dispose();// TODO add your handling code here:
...
this.dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new modificargrafo(grafo).setVisible(true));
    }
