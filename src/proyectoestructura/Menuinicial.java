...
public class Menuinicial extends javax.swing.JFrame {
     ...
     */
    public Menuinicial(Grafo nuevo) {
        initComponents();
        this.grafo = nuevo;
...
Cargararchivo m = new Cargararchivo (grafo);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
modificargrafo l = new modificargrafo (grafo);
this.dispose();// TODO add your handling code here:
...
Actualizarrepositorio m = new Actualizarrepositorio (grafo);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton4ActionPerformed

    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
Identificacionhubs m = new Identificacionhubs (grafo);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton8ActionPerformed

    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
detecciondecomplejos m = new detecciondecomplejos (grafo);
this.dispose();// TODO add your handling code here:
    }//GEN-LAST:event_jButton6ActionPerformed

    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
rutametabolica m = new rutametabolica (grafo);
this.dispose();// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Menuinicial(grafo).setVisible(true));
    }
